...
const fetchQuotas = async () => {
  try {
    setLoadingQuotas(true); // 🔥 début skeleton
    ...
    setLoadingQuotas(false); // 🔥 fin skeleton
  }
};
  ...
  return (
    <div className="grid grid-cols-12 gap-4 items-end
      ...
      <div className="flex justify-end">
        <Button className="rounded-xl border-slate-200 hover:bg-slate-50" type="button" variant="outline" onClick={addSousActeRow}>
          + Ajouter
        </Button>
      </div>
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="relative">
          <Button
            ...
            className="rounded-xl border-slate-200 bg-white
             hover:bg-slate-50 shadow-sm flex gap-2"
          ...
          {filterOpen && (
            <div ref={ignoreRef}>
              <div
                ref={filterRef}
                className="absolute left-0 mt-2 w-64 p-4
                  bg-white rounded-2xl
                  border border-slate-100
                  shadow-xl z-10 transition-transform transform scale-95 animate-scaleIn"
              >
                <div className="grid gap-4">
                  <div className="grid gap-1">
                    ...
                    >
                      <SelectTrigger className="rounded-xl border-slate-200
             focus:ring-[#44adc9]" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button  className="bg-[#44adc9] text-white rounded-xl shadow-sm
             hover:bg-[#3a9ab3] flex items-center gap-2">
              <CirclePlus className="w-4 h-4" /> Nouveaux quota
            </Button>
          </DialogTrigger>
          <DialogContent className="sm:max-w-[425px]
             ...
             shadow-xl">
            <DialogHeader>
              <DialogTitle className="text-lg font-semibold text-slate-800">Nouveaux quota</DialogTitle>
            </DialogHeader>
      ...
      <header className="flex items-center justify-between mb-6">
        <div className="flex flex-col items-center text-center w-full">
          <h3 className="text-xl font-semibold text-slate-800">Quotas</h3>
        ...
        <div className="text-right">
          <span className="text-[#44adc9] text-lg font-bold">{totalActes}</span>
        </div>
      </header>

      {/* Liste des quotas */}
      {/* Liste des quotas */}
      <div className="scrollable mt-4 space-y-3 p-4
             rounded-2xl
             border border-slate-100
             bg-white shadow-sm">
        {loadingQuotas ? (
